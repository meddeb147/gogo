      ...
      <section className="pt-24 pb-16 px-6 hero-gradient">
        <div className="container mx-auto max-w-5xl text-center">
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <Image
                ...
                width={120}
                height={120}
                className="rounded-2xl shadow-xl hover-float"
                priority
              />
              <div className="absolute -inset-4 bg-blue-100 rounded-3xl -z-10 opacity-50 blur-xl"></div>
            </div>
          </div>
          ...
          <p className="text-xl mb-8 text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Need a ride? ViteFait connects you with nearby drivers in seconds. 
            Experience safe, reliable, and affordable transportation across Tunisia.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <button
              ...
              className="bg-blue-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-blue-700 transition-all button-shadow hover-float"
            >
              Download APK
            </button>
            <button
              onClick={() => setActiveDownload('qr')}
              className="bg-white text-blue-600 px-8 py-3 rounded-full text-lg font-semibold border-2 border-blue-600 hover:bg-blue-50 transition-all hover-float"
            >
              Scan QR Code
            </button>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-6xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl hover-float card-shadow bg-gradient-to-b from-white to-blue-50">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">Quick Pickup</h3>
            ...
            <div className="text-center p-6 rounded-xl hover-float card-shadow bg-gradient-to-b from-white to-blue-50">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-800">Safe Rides</h3>
            ...
            <div className="text-center p-6 rounded-xl hover-float card-shadow bg-gradient-to-b from-white to-blue-50">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-800">Best Rates</h3>
              <p className="text-gray-600">Competitive prices, no hidden fees</p>
            </div>
          </div>
        </div>
      </section>
